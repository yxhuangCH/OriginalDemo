...
/**
 *  添加头部或者尾部的 RecyclerAdapter
 *  https://gist.github.com/darnmason/7bbf8beae24fe7296c8a
 */
public class HeaderViewRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public int getItemCount() {
        int count = getHeaderCount() + getFooterCount() + getWrappedItemCount();
//        PayLog.e("PayBill", "getItemCount count " + count);
        return count;
    }
